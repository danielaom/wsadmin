                        ...
                        if (!empty($_GET['id'])) {
                            ...
                            while ($DATA = mysqli_fetch_array($QUERY_OBTENER_USUARIO, MYSQLI_ASSOC)):
                                ...
                                <form id="usuario" class="form-horizontal" action="../controlador/editarCliente.php"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">C&oacute;dula de identidad</label>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input name="dirección" class="input-xlarge form-control focused"
                                                   id="focusedInput" type="text" placeholder="Ingrese dirección…"
            ...
            fields: {
                ...
                ci: {
                    ...
                    validators: {
                        ...
                        regexp: {
                            regexp: /^([E]{0,1})([-]{0,1})([0-9]{5,5})([a-zA-Z]{0,1})([0-9]{0,6})+$/,
               ...
               direccion: {
                    ...
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[a-zA-ZsñÑ\s]+$/,
                            message: 'La dirección no acepta  caracteres especiales '
                        },
                        stringLength: {
                            min: 15,

                            message: 'El telefono debe contener minimo 15 caracteres'
                        }
