          ...
          <div class="panel panel-danger">
            <div class="panel-heading" width="20px" length="50px">
              <h2 class="panel-title"><?php echo $row ['nombre']; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              	<button style="text-align:right" data-toggle="modal"  data-target="#loginModal"  type="button" class="btn btn-default btn-xs btn-round"><span class="glyphicon glyphicon-plus"></span></button></h2>
            </div>
            ...
            <div class="panel-footer">
            	<table>
            		<tr>
              <td><a href="#" class="btn btn-danger"><span class="glyphicon glyphicon-remove">Negar</a></td>
             <td> &nbsp;</td>
              <td><a href="#" class="btn btn-danger">Aceptar<span class="glyphicon glyphicon-menu-right"></a></td>
              </tr>
              </table>
            </div>
          </div>
